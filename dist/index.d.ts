...
declare const Breadcrumbs: {
    ({ useDefaultStyle, rootLabel, omitRootLabel, labelsToUppercase, replaceCharacterList, transformLabel, omitIndexList, containerStyle, listStyle, listClassName, inactiveItemStyle, inactiveItemClassName, activeItemStyle, activeItemClassName, staticBreadcrumbs, className, }: BreadcrumbsProps): JSX.Element | null;
